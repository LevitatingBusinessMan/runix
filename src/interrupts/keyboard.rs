    ...
    impl TryFrom<KeyCode> for char {
        ...
        fn try_from(value: KeyCode) -> Result<char, ()> {
            match value {
                ...
                KeyCode::RightShift => Ok('\0'),
                KeyCode::NumPadStar => Ok('*'),
                KeyCode::LeftAlt => Ok('\0'),
                KeyCode::Space => Ok(' '),
                KeyCode::CapsLock => Ok('\0'),
                KeyCode::F1 => Ok('\0'),
                KeyCode::F2 => Ok('\0'),
                KeyCode::F3 => Ok('\0'),
                KeyCode::F4 => Ok('\0'),
                ...
                KeyCode::F9 => Ok('\0'),
                KeyCode::F10 => Ok('\0'),
                KeyCode::NumLock => Ok('\0'),
                KeyCode::ScrollLock => Ok('\0'),
